...
import {
  FileUp, MapPin, PencilLine, Weight, MessageSquareText,
  Soup, Factory, Leaf, DollarSign, Brain, Recycle
} from "lucide-react";
    ...
    <div className="max-w-2xl mx-auto px-4 py-10">
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <label className="input flex items-center gap-2">
          ...
          <input placeholder="upload file/images " required name="proof" type="file" accept="image/*,.pdf" className="w-full bg-transparent outline-none" />
        </label>
